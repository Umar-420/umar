...
uid = os.getuid()
key1 = open('/data/data/com.termux/files/usr/bin/.mrakingxxx-cov', 'r').read()
kex=(f"UMAR-XD~CREATE:{uid}TS{key1}110E==")
...
------------------------------------------
 Author : Mr.Umar
 Github : Umar-420 (Follow Must)
 Tools  : Auto Facebook Register
 Contact: +923086225878
 Version: 1.1
\033[1;37m------------------------------------------""") 
try:
    clear()
...
def Create():
    ...
    def strt():
       try:
           ...
           import sys
           loop+=1
           sys.stdout.write('\r\r\033[1;37m [UMAR-CREATE] \033[1;32mOK:%s \033[1;37m'%(ok));sys.stdout.flush()
           requests=r.Session()
           from fake_email import Email
           mmail=Email().Mail()
           em=mmail['mail']
           ...
           if "9":
              ...
              if requests=="chk":
                ...
                pass
                 ...
                 print("\r\r\033[1;32m [UMAR-OK] "+uid+'|'+pas+'|'+coki)
                 ok+=1
           ...
           pass
    file="/sdcard/UMAR/CREATE-OK.txt"
    u=5000
    clear()
    print(' Use Airplane Or Use IP Changer if ids coming cp ')
    print(' ids will be save in /sdcard/UMAR/CREATE-OK.txt')
    linex()
